...
* **Using welcoming and inclusive language.** Treat every Disciple and Sensei with respect.
* **Being respectful of differing viewpoints and experiences.** We learn from each other.
* **Gracefully accepting constructive criticism.** A true master is always learning.
...
* Plagiarism or claiming another's code/solution as your own without attribution.
* Other conduct which could reasonably be considered inappropriate in a professional setting.

## Enforcement Responsibilities

Project maintainers (Senseis and Guardians) are responsible for clarifying the standards of acceptable behavior and are expected to take appropriate and fair corrective action in response to any instances of unacceptable behavior.
