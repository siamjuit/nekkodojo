...
export default function QuestionsDashboard({ initialCategories, allCompanies }: Props) {
  ...
  useEffect(() => {
    ...
    // Small timeout to prevent flickering on rapid typing/clicking
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-[#3e2723] bg-[#1a110d]/40 overflow-hidden min-h-[300px]">
                    ...
                    <tr key={q.id} className="group hover:bg-[#3e2723]/10 transition-colors">
                      ...
                      <td className="p-4">
                        <Link
                          ...
                          target="_blank"
                          className="font-medium text-[#eaddcf] hover:text-[#d4af37] hover:underline"
                        >
                          {q.title}
                        </Link>
                      </td>
